# Generated by Powerlevel10k configuration wizard on 2022-10-25 at 16:46 PDT.
...
() {
  ...
  # typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|fluxctl|stern'
